...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_Menu2['default'], { items: ['Home', 'Services', 'About', 'Contact us'] }), document.body);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          this.props.items.map(function (m, index) {
	            ...
	            return _react2['default'].createElement(
	              'li',
	              { className: style, onClick: _this.clicked.bind(_this, index) },
	              m
	            );
	          })
	        ),
