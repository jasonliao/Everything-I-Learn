...
// css
L_cutSquare.prototype.style = function() {
	//背景的样式 
...
//获取id
L_cutSquare.prototype.$ = function(id) {
	return document.getElementById(id);
};

//创建div
L_cutSquare.prototype.ce = function(id) {
...
//小点点的部分样式 
L_cutSquare.prototype.dragCornerStyle = function(ele) {
...
//移动
L_cutSquare.prototype.move = function() {
	var me = this.me;
...
//左上角调整
L_cutSquare.prototype.nw_resize = function() {
	var me = this.me;
...
//右上角调整
L_cutSquare.prototype.ne_resize = function() {
	var me = this.me;
...
//左下角调整
L_cutSquare.prototype.sw_resize = function() {
	var me = this.me;
...
//右下角调整
L_cutSquare.prototype.se_resize = function() {
	var me = this.me;
...
//上中调整
L_cutSquare.prototype.tc_resize = function() {
	var me = this.me;
...
//下中调整
L_cutSquare.prototype.bc_resize = function() {
	var me = this.me;
...
//左中调整
L_cutSquare.prototype.lc_resize = function() {
	var me = this.me;
...
//右中调整
L_cutSquare.prototype.rc_resize = function() {
	var me = this.me;
...
//总调整 
L_cutSquare.prototype.resize = function() {
	this.nw_resize();
	this.ne_resize();
	this.sw_resize();
	this.se_resize();
...
//出现函数 
L_cutSquare.prototype.show = function(element) {
...
//清除函数 
//清除 <div id='L_cutSquare'> 里的东西
L_cutSquare.prototype.destory = function() {
